...
import { exploreWorlds, SESSION_EXPIRED as W_SESSION, type ExploreWorldSummary } from "../api/worlds";
...
export function HomePage() {
  ...
  const loadExplore = useCallback(async (t: string) => {
    setError(null);
    try {
